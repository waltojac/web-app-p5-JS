...
$i = 1;
$result = $db->query("SELECT * FROM customer, rental where customer.store_id = $store and customer.customer_id = rental.customer_id and rental.return_date is null order by last_name");
